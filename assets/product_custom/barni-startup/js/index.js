...
$('.see-all-og-them').click(function(){
  ...
  if ($(this).hasClass('components')) {
    ...
    document.getElementById('content-lightbox_1').innerHTML = loadPage(base_url + "assets/product_custom/barni-startup/"+ 'screen-load-content-1.html');

  } else if ($(this).hasClass('startup')) {

    $('.header-lightbox_content li').removeClass('active');

    $('.header-lightbox_content li:nth-child(4)').addClass('active');

    $('#content-lightbox_1').addClass('left').hide();

    $('#content-lightbox_3').show().removeClass('right').removeClass('left').addClass('active').nextAll().addClass('right').hide();

    document.getElementById('content-lightbox_3').innerHTML = loadPage(base_url + "assets/product_custom/barni-startup/"+ 'screen-load-content-3.html');
...
$('.header-lightbox_content ul li').click(function(){
  ...
  if ($('content-lightbox_2:visible')){
      ...
      document.getElementById('content-lightbox_2').innerHTML =  loadPage(base_url + "assets/product_custom/barni-startup/"+ 'screen-load-content-2.html');;
  ...
  if ($('content-lightbox_3:visible')){
   ...
   if ($('content-lightbox_4:visible')){
      ...
      document.getElementById('content-lightbox_4').innerHTML = loadPage(base_url + "assets/product_custom/barni-startup/"+ 'screen-load-content-4.html');
